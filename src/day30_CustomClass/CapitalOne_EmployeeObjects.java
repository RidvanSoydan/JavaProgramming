...
public class CapitalOne_EmployeeObjects {
    ...
    public static void main(String[] args) {
        ...
        Employee [] emplooyees = {employee1, employee2, employee3, employee4,employee5};


        int countFullTime = 0;
        int countPartTime = 0;
        double max = emplooyees[0].salary;
        double min = emplooyees[0].salary;

        for (Employee emplooyee : emplooyees) {

            if (emplooyee.isFullTime){
                countFullTime++;
            ...
            if (emplooyee.salary > max){
                max = emplooyee.salary;
            }

            if (emplooyee.salary < min){
                min = emplooyee.salary;
            }
