...
public class MapPractice1 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // {Kakalina=Female, Glad=Female, Jereme=Male, Bertrando=Male, Winfred=Male, Marika=Female, Ddene=Female,
        // Selle=Female, Orlando=Male, Brigitte=Female, Desirae=Female, Derk=Male, Ajay=Female}
        ...
        for (Map.Entry<String, String> eachPair : employeeMap.entrySet()) {
            ...
            if(eachValue.equals("Female")){
                System.out.print(eachKey + " "); //Kakalina Glad Marika Ddene Selle Brigitte Desirae Ajay
            }
