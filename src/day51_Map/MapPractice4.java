...
public class MapPractice4 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Map<Integer, ArrayList<String>> groups = new TreeMap<>(); // Tree Map => Keeps in sorted order
        groups.put(1, group1);
        groups.put(2, group2 );
        groups.put(9, group9);
        ...
        for (Map.Entry<Integer, ArrayList<String>> each : groups.entrySet()) {
            if (each.getKey().equals(24)){
                System.out.println("Names in group 24 = " + each.getValue());
            }
        }
