...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer3.setInfo("FL", "Apple Inc", "QE", 99000, true,
                       true, true, false);

        Offer offer4 = new Offer ();
        offer4.setInfo("TX", "CapitalOne", "SM", 95000, false,
                       false, true, true);
        ...
        fullTimeOffers.removeIf (p -> p.isFullTime == false);  // removes the offer if the offer is NOT fulltime
