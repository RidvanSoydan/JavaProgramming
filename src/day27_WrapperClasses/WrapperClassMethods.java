...
public class WrapperClassMethods {
    ...
    public static void main(String[] args) {
        ...
        String str = "123"; // All chars are digit... So it can be converted
        ...
        // valueOf method  returns wrapper
        ...
        //Character class ==> isDigit(), isLetter(), isLetterOrDigit(), isUpperCase(), isLowerCase() methods...
        ...
        //find the sum of the digits inside the string
