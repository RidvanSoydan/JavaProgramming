...
public class NestedMap {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Map<Integer, String>, Map<String, Integer>> mapOfMapEntry : mapOfMap.entrySet()) {

            for (Map.Entry<Integer, String> entry : mapOfMapEntry.getKey().entrySet()) {
        ...
        Map< Map<Map<Integer, Integer>, Map<Integer, Integer>>,
                Map<Map<Integer, Integer>, Map<Integer, Integer>> > mapOfMapOfMap = new LinkedHashMap<>();
