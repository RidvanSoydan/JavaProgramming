...
public class ListOfMapPractice1 {
 ...
 //    1.1 Create a data structure that can contain all the given maps above
   ...
   //   scrumTeams.addAll((Collection<? extends LinkedHashMap<String, String>>) Arrays.asList((LinkedHashMap) scrumTeam3,
        //                 (LinkedHashMap) scrumTeam4, (LinkedHashMap) scrumTeam5));
