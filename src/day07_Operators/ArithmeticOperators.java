...
public class ArithmeticOperators {
    ...
    public static void main(String[] args) {
        ...
        //Expected Output; 10 divide by 3 is equal to 3 with a remainder is 1

        System.out.println(num1 + " divide by " + num2 + " is equal to " + division + " with a remainder is " + remainder);
