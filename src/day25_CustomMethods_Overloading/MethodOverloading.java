...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(intArray);  // sort is overloading method...
                                // it has same functions with different data types...
                                // So we need to memorize just the sort if we want to sort the elements ascending order..
