...
public class PolymorphismPractice_T1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(carWithHighestMileage); // Car{brand='Toyota', model='Corolla', year=2011, price=20000.0, color='White', miles=310000}
        System.out.println(carWithLowestMileage);  // Car{brand='BMW', model='i3', year=2011, price=30000.0, color='Black', miles=9000}
