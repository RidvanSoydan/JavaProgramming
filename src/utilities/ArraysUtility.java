...
public class ArraysUtility {
    ...
    //swaps the elements of given indexes, returns the new array
    ...
    //inserts an element to array at given index, returns the new array
    ...
    //prints the peak element/elements of int array (peak means bigger than its neighbours not the max number)
    public static void peakElement (int[] array) {
