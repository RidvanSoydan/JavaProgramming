...
public class InsuranceQuote {
    ...
    public static void main(String[] args) {
        ...
        double discountRate = 0; //discountRate calculation:
        ...
        /*Create a class called InsuranceQuote, write a program that
        can calculate the insurance cost of a person based on the following info:
